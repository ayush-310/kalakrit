...
import '../Home/slidingCards/slider.css'
...
const SlidingCard = () => (
  <div className="w-screen">
    <InfiniteLooper speed="8" direction="left">
      <div className="w-full md:w-[80px] h-32  mx-12 hover:scale-125 rounded-xl text-center">
      <svg
              width="80"
              height="80"
              viewBox="0 0 56 56"
              class="apna-time-logo"
            >
      ...
      <div className=" w-full md:w-[110px] h-auto flex items-center  mx-12 hover:scale-125 rounded-xl text-center">
      ...
      <div className=" w-full md:w-[110px] h-auto mx-12 hover:scale-125 flex items-center rounded-xl text-center">
