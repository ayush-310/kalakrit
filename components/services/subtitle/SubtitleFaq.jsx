  ...
  return (
    <>
      <div className='w-full bg-[#100f13] py-20 '>
        <div className='w-11/12 flex flex-wrap md:flex-nowrap m-auto '>
          ...
          <div className='md:w-1/2 w-full  m-auto text-center py-16'>
          
          <h1 className=' md:text-3xl text-xl font-semibold text-[#ffffff] '>Frequently asked questions</h1>
        </div>
        </div>
      </div>
    </>
