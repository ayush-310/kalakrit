  ...
  return (
    <nav
      ...
      className={`${isSticky
        ...
        : "bg-black fixed top-0 left-0  m-auto z-50 w-full p-0 "
        ...
        <div className=" ">
          ...
          <div ref={menuRef}>
            <div ref={scope}>
              ...
              {/* Right slide menu */}
              <div
                className={`nav fixed top-0 right-0 h-screen w-64 bg-[#201f22] p-4 transition-transform transform ${isMenuOpen
              ...
              >
                ...
                <ul className="flex flex-col pt-12 space-y-4 ">
                  <Link href="/services">
                    <li className=" hover:text-[#eb5a00] captalize underline underline-offset-4  ">
                      SERVICES
                    </li>
                  </Link>
          ...
          <div className="flex justify-between items-center p-2">
            ...
            <div className="hidden  m-auto space-x-6 lg:flex justify-between items-center">
              ...
              >
                ...
                >
                  <div
                    ...
                    className="flex items-center text-[#f6f6f6] hover:text-[#eb5a00] captalize font-medium justify-center cursor-pointer"
                  >
                    <span
              ...
              <Link href="/about-us">
                <span
                  className={`cursor-pointer py-4 nav font-medium  text-[#f6f6f6] px-2 hover:text-[#eb5a00] captalize ${activeItem === "portfolio" && " border-b-2 border-[#eb5a00]"
                    }`}
              ...
              <Link href="/contact-us">
                <span
                  className={`cursor-pointer py-4 nav font-medium text-[#f6f6f6] px-2 hover:text-[#eb5a00] captalize ${activeItem === "contact-us" &&
                    " border-b-2 border-[#eb5a00]"
                    }`}
              ...
              <div className="">
                <Link href="/services/translation-localization">
                  <button className="hover:drop-shadow-[0_10px_10px_rgba(0,0,0,0.25)]">
                    <span
                      onClick={() => handleItemClick("services")}
                      className={`${activeItem === "services" && "border-b-2 border-[#eb5a00]"
